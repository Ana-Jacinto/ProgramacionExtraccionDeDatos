...
if __name__ == "__main__":
    ...
    try:
        ...
        data_df = filtrado(navegador, ["celulares-y-telefonia-li", "electronica-y-tecnologia-li", "videojuegos-li", "hogar-y-jardin-li", "deportes-y-ocio-li", "ferreteria-y-autos-li", "salud-belleza-y-cuidado-personal-li"])
        data_df.to_csv(data_csv)
        cerrar_navegador(navegador)
        print("Web scraping realizado exitosamente.")

    except Error as error:
        print("Error al realizar el web scraping:", error)
