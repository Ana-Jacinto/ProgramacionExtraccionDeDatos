...
def render_page_content(pathname):
    if pathname == "/":
        ...
        return html.Div([
            ...
            html.Br(),
            html.H2("Análisis:", style={'color': '#2F4F4F'}),
            html.P("Esta gráfica, que es complementaria a la primera, nos permite observar específicamente la cantidad de descuento (en MXN) que Claro Shop le aplica "
                   "a cada uno de sus productos. Para la competencia esta información le ayudará a ajustar sus estrategias de fijación de "
                   "precios, ofreciendo productos similares a precios más atractivos o adaptar sus ofertas para competir más efectivamente en el mercado.", style={'text-align': 'justify'}),
            html.Br(),
            html.Div(
                dcc.Dropdown(
